...
/*   Updated: 2024/02/19 14:00:09 by tfrily           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @param data  
 * @param x 1 is the distance the number move. 
 *		  By default 1 for 1 tile on the map.
 * @return int 
 */
 ...
 * 
 * @param data 
 * @param y 1 is the distance the number move. 
 *	By default 1 for 1 tile on the map.
 * @return int 
 */
...
int	ft_controls(t_data *data)
{
	...
	mlx_hook(data->window, 17, 0, ft_buttonquit, data);
	return (0);
}
